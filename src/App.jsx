...
import { varients } from "./components/motion_variants";
  ...
  return (
    <>
        ...
        {isModalOpen == true && (
          ...
          >
            ...
            <form
              ...
              ref={formElement}
            >
              <label id="form_heading">Have an idea?</label>
      ...
      <main>
        ...
        <section id="showcase" className="flexCol">
          <Showcase />
        </section>
        ...
        <section id="about" className="flexRow">
          <AnimatePresence>
            ...
            >
              ...
              <p>
                I am a new UX Designer & Programmer passionate about delivering
                creative designs and code backed behind effective design
                strategies and methods
              </p>
              <p>
                I've done work as a social media manager for my University's
                E-Sports team: creating social media content and brand imagery
                that best represents the team, I was also a Teacher Assistant:
                helping new students learn to program by using Python
              </p>
              <p>
                Outside of school, I've done social media consulting for friends
                and family and have been building my own personal brand
              </p>
              <p>
                The projects that I've done aren't just social media and
                branding, I've made Websites, Unity Games, 3D models,
                Videos/Edits, Graphics and Animations
              </p>
            </motion.div>
